...
\begin{figure}
  \label{MOSFET_circuit}
  \centerline{\includegraphics[width=5cm]{MOSFET_circuit.png}}
  \caption{OhYes}
\end{figure}

In this experiment we used two MOSFETs with gate terminal and source terminal connected. Circuit is set as \ref{MOSFET_circuit}.
