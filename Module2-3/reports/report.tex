...
\begin{figure}
  \centerline{\includegraphics[width=5cm]{figures/MOSFET_circuit.png}}
  \caption{OhYes}
  \label{MOSFET_circuitfig}
\end{figure}

In this experiment we used two MOSFETs with gate terminal and source terminal connected. Circuit is set as \ref{MOSFET_circuitfig}.
